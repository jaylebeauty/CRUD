...
<div class="container">
			...
			<table class="table table-bordered table-hover" id="tab_logic">
				...
				<tbody>
					<tr id='addr0'>
						...
						<td>
						<input required type="number" name="age" id="age" placeholder='Age' class="form-control" onKeyPress="if(this.value.length==2) return false;"/>
						</td>
                        <td>
    ...
    <button class="btn btn-lg btn-block btn-primary" onclick="Add()">Add data</button>
    <br/>
</div>
<div class="container">
    <div class="row clearfix">
        ...
        <tr>
            ...
            onclick="Edit(<?php echo $data?>)">EDIT</button>
            <button type="button" class="btn btn-warning" pull-left
            onclick="Delete(<?php echo $data?>)">DELETE</button>
            <?php echo'
			</td>
        </tr>';
            }
...
function Add() {
    ...
    $.ajax({
        type: "POST",
        url: "Add_backend.php",
        data: {name:name,address:address,age:age,attend:attend},
    ...
    //window.open("Add_backend.php?name="+name +"&address="+address 
    //+"&age="+age +"&attend="+attend , "_blank");
}

function Edit(data){
    //alert(data);
    window.open("Edit.php?data="+data , "_blank");
}
...
function Delete(data){
    ...
    //window.open("Delete_backend.php?data="+data , "_blank");
}
</script>
